...
const haushaltsbuch = {
    ...
    eintraege_anzeigen() {
        document.querySelectorAll(".monatsliste ul").forEach(eintragslsiste => eintragslsiste.remove());
    ...
    html_gesamtbilanz_generieren() {
        ...
        this.gesamtbilanz >= 0 ? bilanz_betrag.setAttribute("class", "positiv") : bilanz_betrag.setAttribute("class", "negativ");
